...
function About(){
    ...
    return(
      ...
      <Container style={{ marginTop: 15 }}>
          ...
          <Row>
            <Col xs={3}>
              <img className="img" src={Bio} alt="Nina, a late 30's woman is smiling"
               />
            </Col>
             <Col xs={9}>
                  <h3>Welcome to my page!</h3>
                  <p className="card-text" style={{fontSize:18}}> My name is Nina Rocket and I am a full time working Mom
            ...
            <Row>
              <Col className="links" size="md-12">  
                    <p>
                        ...
                        <a className="link" href="https://github.com/NinaRocket">Nina's GitHub</a>
                        <br />
                        <a className="link" href="https://www.linkedin.com/in/ninarocket/">Nina's LinkedIn</a>
                        <br />
                    
                        <h3>Extracurricular Activities:</h3>
                        <a className="link" href="https://medium.com/@enRocket">Nina's Blog</a>
                        <br />
                        <a className="link" href="https://www.visualizingimmigrantphoenix.com/individual-projects/nina-rocket/">2018
                            Visualizing Immigrant Phoenix Project</a>
                        <br />
                        <a className="link" href="https://karachi2018.jimdofree.com/">2018 Karachi, Pakistan: Walking Between Slums and
